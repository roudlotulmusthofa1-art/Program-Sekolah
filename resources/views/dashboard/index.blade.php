...
@section('content')
    ...
    {{-- ── Greeting Banner ─────────────────────────────────────────────── --}}
    <div class="relative rounded-2xl overflow-hidden mb-6 fade-in fade-in-1"
        ...
        <div class="px-8 py-6">
            ...
            <p class="text-white/70 text-sm">Dashboard Super Admin - Ribath Masjid Riyadh</p>
        </div>
        {{-- Dekoratif Arabic --}}
        <div class="absolute right-8 bottom-4 text-white/15 text-3xl font-arabic select-none" dir="rtl">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        {{-- Total Santri --}}
        <div class="stat-card bg-blue-50 rounded-xl p-5 border border-gray-100 fade-in fade-in-1">
        ...
        {{-- Total Ustadz --}}
        <div class="stat-card bg-amber-50 rounded-xl p-5 border border-gray-100 fade-in fade-in-2">
            <div class="flex items-start justify-between mb-3">
        ...
        {{-- Santri Baru --}}
        <div class="stat-card bg-teal-50 rounded-xl p-5 border border-gray-100 fade-in fade-in-3">
            <div class="flex items-start justify-between mb-3">
        ...
        {{-- Tagihan Pending --}}
        <div class="stat-card bg-orange-50 rounded-xl p-5 border border-gray-100 fade-in fade-in-4">
            <div class="flex items-start justify-between mb-3">
    ...
    {{-- ── Input Bulanan ───────────────────────────────────────────────── --}}
    <div class="mb-6 fade-in fade-in-2 bg-white rounded-xl border border-gray-200 p-5 fade-in fade-in-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        ...
        {{-- Waktu Sholat --}}
        <div class="bg-emerald-50 rounded-xl border border-green-300 p-5 fade-in fade-in-3">
        ...
        {{-- Kalender --}}
        <div class="bg-white rounded-xl border border-gray-300 p-5 fade-in fade-in-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="bg-white rounded-xl border border-gray-100 p-5 fade-in fade-in-5">
        ...
        {{-- Status Keuangan --}}
        <div class="bg-white rounded-xl border border-gray-100 p-5 fade-in fade-in-6">
            <div class="flex items-center justify-between mb-4">
