    ...
    <div class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
        ...
        <div class="max-w-7xl mx-auto p-6">
            ...
            <div class="flex justify-between items-center text-sm mb-2 text-primary-teal font-medium">
                <span>Step 4 dari 9</span>
                <span>34% selesai</span>
            </div>

            <div class="w-full bg-inactive-gray rounded-full h-1.5 mb-6">
                <div class="bg-yellow-400 h-1.5 rounded-full" style="width: 34%"></div>
            </div>
            ...
            ring-4 ring-teal-200 mb-2">
                        ...
                        <!-- ICON  -->
                        <svg class="w-5 h-5 text-gray-800 dark:text-teal-600" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 3v4a1 1 0 0 1-1 1H5m4 6 2 2 4-4m4-8v16a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V7.914a1 1 0 0 1 .293-.707l3.914-3.914A1 1 0 0 1 9.914 3H18a1 1 0 0 1 1 1Z"/>
    ...
    <main class="pt-10">
        ...
        <div class="max-w-4xl mx-auto px-6 md:px-12 py-10  ">
            ...
            <div class="bg-primary-teal  p-6 border-b  border-gray-50 rounded-xl">
                <div class="flex items-center space-x-3 mb-2">
                    ...
                    <h1 class="text-3xl font-bold text-gray-50">Kesehatan</h1>
                </div>
            ...
            <form action="{{ route('pendaftaransiswa.storeStep4') }}" method="POST"
                ...
                focus:border-transparent">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="medical_history" rows="3" placeholder="Sebutkan jika ada riwayat penyakit yang perlu diketahui"
                                class="w-full
            min-h-30
            px-4
            py-3
            ...
            focus:border-transparent"></textarea>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="allergy" rows="3" placeholder="Sebutkan jika ada alergi makanan, obat, atau lainnya"
                                class="w-full
            min-h-30
            px-4
            py-3
            ...
            focus:border-transparent"></textarea>
                        ...
                        <div class="space-y-2">
                            <label class="block mb-1 mt-4 text-[15px] font-medium text-gray-900">
                                Kondisi Kesehatan Khusus (opsional)
                            </label>

                            <textarea name="special_condition" rows="4"
                                placeholder="Sebutkan jika ada kondisi kesehatan khusus yang memerlukan perhatian"
                                class="w-full
            min-h-30
            px-4
            py-3
        ...
        py-5 mt-3">
                            ...
                            <div class="flex items-start gap-2">
                                ...
                                <p class="text-[15px] leading-6 text-blue-700">
                                    Data kesehatan akan digunakan untuk keperluan medis
        ...
        flex items-center justify-between">
                            ...
                            <!-- Button Sebelumnya -->
                            <a href="{{ route('pendaftaransiswa.step3') }}"
